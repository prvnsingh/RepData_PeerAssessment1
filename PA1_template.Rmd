...
hist(steps_day$steps, main = "mean total number of steps taken per day", xlab = "mean steps per day", breaks = 50)
...
hist(steps_day2$steps, main = "mean total number of steps taken per day", xlab = "mean steps per day", breaks = 50)
